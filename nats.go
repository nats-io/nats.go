...
type Options struct {
	...
	// AuthErrCB sets the callback that is invoked whenever a
	// authorization failed
	AuthErrCB ErrHandler
...
// AuthErrHandler is an Option to set the auth error handler.
func AuthErrHandler(cb ErrHandler) Option {
	return func(o *Options) error {
		o.AuthErrCB = cb
		return nil
	}
...
func (nc *Conn) processAuthError(err error) bool {
	...
	if nc.Opts.AuthErrCB != nil {
		nc.ach.push(func() { nc.Opts.AuthErrCB(nc, nil, err) })
	}
